...
struct Complex {
  ...
  Complex
  abs() const {
    return Complex(std::abs(x), std::abs(y));
  }
  ...
  Complex
  pow(const realType &other) const {
...
inline std::istream &
operator>>(std::istream &is, Complex &c) {
  char ch;
...
inline Complex
operator+(const realType &scalar, const Complex &c) {
...
inline Complex
tanh(const Complex &c) {
  return c.tanh();
}
inline Complex
asin(const Complex &c) {
  return c.asin();
}
inline Complex
acos(const Complex &c) {
  return c.acos();
}
inline Complex
atan(const Complex &c) {
  return c.atan();
}
inline Complex
asinh(const Complex &c) {
  return c.asinh();
}
inline Complex
acosh(const Complex &c) {
  return c.acosh();
}
inline Complex
atanh(const Complex &c) {
  return c.atanh();
}
inline Complex
abs(const Complex &c) {
...
Complex
polar(const realType &r, const realType &theta) {
  return Complex(r * std::cos(theta), r * std::sin(theta));
}
Complex
cartesian(const realType &r, const realType &theta) {
  return Complex(r * std::cos(theta), r * std::sin(theta));
}
#endif // COMPLEX_H